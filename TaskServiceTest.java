...
class TaskServiceTest {
	...
	void setUp() {
		...
		testTaskService.addTask(new Task("1", "Emma", "description1"));
		testTaskService.addTask(new Task("2", "John", "description2"));
	}
	...
	void testAddTask(){
		assertAll(
			() -> assertTrue(testTaskService.addTask(new Task("3", "Linda", "Colleague"))),
	...
	void testAddTaskThatAlreadyExists() {
		assertAll(
			() -> assertFalse(testTaskService.addTask(new Task("2", "Gabriellle", "Friend"))),
